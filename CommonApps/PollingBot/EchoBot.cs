    ...
    public class EchoBot : IDialog<object>
    {
        ...
        public async Task MessageReceivedAsync(IDialogContext context, IAwaitable<IMessageActivity> argument)
        {
            ...
            if (activity.Text == null)
                ...
                if(activity.Text!=null)
                    message = Bot.Connector.Teams.ActivityExtensions.GetTextWithoutMentions(activity).ToLowerInvariant().Trim();
        ...
        public static async Task<string> SendNotification(IDialogContext context, string userOrChannelId, string messageText, Bot.Connector.Attachment attachment, string updateMessageId)
        {
            ...
            try
            {
                ...
                if (objFeedBackData.Count() > 0 && objFeedBackData != null)
                {
                    try
                    {
                        ...
                        //        {
                        //            ws.Cells[j + 2, k + 1] = table.Rows[j].ItemArray[k].ToString();
                        //        }
                        //    }
                        //}
                        ...
                        //excelWorkBook.SaveAs(ExcelPath, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Excel.XlSaveAsAccessMode.xlExclusive, Type.Missing, Type.Missing, Type.Missing,
                        //           Type.Missing, Type.Missing);

                        ////excelWorkBook.SaveAs(@"C\FeedBack.xls", Microsoft.Office.Interop.Excel.XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
